...
<div className='w-6/12 flex flex-col items-stretch justify-around'>
    <div className='mx-8 mt-5 xl:mt-6 2xl:mt-8' >
        ...
        <span className='ml-4 text-qblue-900 sm:text-sm 2xl:text-xl text-md font-bold'>{nw.title1}</span>
        </div> 
    </div>     
    ...
    <div className='mx-8 mb-5 xl:mb-6 2xl:mb-8' ><div className='flex items-center '>{nw.image && (<img className='border p-1 border-qblue' src={nw.media_2_logo.url} width={80} height={80} /> ) }  
        <span className='ml-4 text-qblue-900 sm:text-sm 2xl:text-xl text-md font-bold'>{nw.title2}</span>
                                </div>
    </div>              
</div>


<div className='bg-white border-l border-qblue-900 rounded-r-lg w-2/12 flex flex-col justify-center items-center'>
