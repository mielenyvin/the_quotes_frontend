...
<div id="newsarticlefeatured" className='p-0.5 container mx-auto flex flex-wrap flex-col sm:flex-col md:flex-row items-stretch
 bg-gradient-to-l from-qlitegray via-qlitegray to-qlitegray cursor-pointer rounded-2xl mb-5 ' >

<div id="newsarticlefeatured" className='container mx-auto flex flex-wrap flex-col sm:flex-col md:flex-row items-stretch
 bg-qverylitegray  cursor-pointer rounded-xl shadow-md hover:shadow-lg' >
...
<div className='w-6/12 flex flex-col items-stretch justify-around'>
    <div className='mx-8 mt-5 xl:mt-6 2xl:mt-8' >
        <div className='flex items-center '>{nw.image && (<img className='border p-1' src={nw.media1_logo.url} width={80} height={80} /> ) } 
    ...
    <div className='mx-8 mb-5 xl:mb-6 2xl:mb-8' ><div className='flex items-center '>{nw.image && (<img className='border p-1' src={nw.media_2_logo.url} width={80} height={80} /> ) }  
