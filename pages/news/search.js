...
export default function SearchPage({ news }) {
  ...
  return (
    <Layout title='Search Results'>
       <Link href='/'><div className='flex flex-row items-center text-blue-900  hover:text-blue-800'><div className='pr-1'><FaCaretLeft /></div><div className='pb-1'>Go Back</div></div></Link>
