...
export default function SearchPage({ news }) {
  ...
  return (
    <Layout title='Search Results'>
       <Link href='/'><div className='flex flex-row items-center text-gray-500 text-qblue  hover:text-qellow'><div className='pr-1'><FaCaretLeft /></div><div className='pb-1'>Go Back</div></div></Link>
