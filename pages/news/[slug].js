...
{/* MAIN CONTAINER */}
<div className='w-full flex flex-col md:flex-row bg-gray-700 rounded-lg shadow-md '> 
...
<div className='w-full lg:w-6/12 mt-5 p-5 md:flex-row bg-gray-700 rounded-lg shadow-md '> 
...
<div className='w-full lg:w-6/12 mt-5 lg:ml-5 p-5  bg-gray-700 rounded-lg shadow-md '> 
