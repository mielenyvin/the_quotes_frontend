        ...
        <Layout title='About the Quotes'>
            ...
            <div className='bg-white shadow-md p-5 rounded-lg py-6 '>
               ...
               <p><span className='font-bold'>Dmitrii Kotikov</span> (Russia)</p>
                ...
                <Image className='ml-3' className='rounded-xl ' src='/images/dmitrii.jpg' width={100} height={100} alt='DK'/>
                ...
                <div className='flex flex-row items-center'>
                <Image className='ml-3' className='rounded-xl border border-qgrey' src='/images/logo.png' width={100} height={100} alt='JH'/>
                ...
                <div className='flex flex-row items-center'>
                <Image className='ml-3' className='rounded-xl' src='/images/prabhmeet.jpg' width={100} height={100} alt='PS'/>
